...
Use a separate exchange for queued execution.
Queued workers permit one automatic retry per stage for worker failures; see the [recovery policy](recovery.md).
